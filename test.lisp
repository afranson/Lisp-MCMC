...
; with no supplies functions, loading will suggest what functions to use (saving doesn't currently serialize functions, just saves their string names)
...
;; Just create the normal walker and double, triple, etc. everything up for global fits or multiple data sets
(walker-create woig
	       ...
	       ; Also can give a list of stddev values for each individual point
